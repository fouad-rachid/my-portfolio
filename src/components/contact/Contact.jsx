...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_rivpyi3', 'template_73bdwck',formRef.current, 'Y0aoQzO7V4g9sPYlI')
        .then((result) => {
            setSuccess(true);
        }, (error) => {
            setError(true);
    ...
    whileInView="animate">
            ...
            <motion.div className="textContainer">
                ...
                <motion.div className="item">
                    <h2>Email</h2>
                    <span>dev.rachidfouad@gmail.com</span>
                </motion.div>
                <motion.div className="item">
                    <h2>Adress</h2>
                    <span>Alger alger</span>
                </motion.div>
                <motion.div className="item">
                    <h2>Phone</h2>
                    <span>+213 557 35 30 25</span>
                </motion.div>
            ...
            <svg fill="orange" height="450px" width="450px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.107 512.107" xml:space="preserve">
                <g>
                    <g>
                        <motion.path 
                        fill="none" 
                ...
                transition={{delay:4 ,duration:1}}>
                    ...
                    {/* <motion.button whileHover={{background:"rgb(68, 255, 0)"}}>Send</motion.button> */}
                    <button>Send</button>
                    {error && "Error" }
                    {success && "Success" }
